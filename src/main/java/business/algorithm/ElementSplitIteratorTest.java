 ...
 */
public class ElementSplitIteratorTest extends AbstractMain {
    ...
    public static void main(String[] args) {
        ...
        exp.addTableName("mature_corpus_plugin004");
        new ElementSplitIteratorTest().deal(exp, null);
    }
...
//        return new OracleTarget(connection, software);
        return new TextFileTarget("C:\\Users\\joshua\\Desktop\\文本提取\\测试流程.txt", "DOC_ID");
    }
}
