 ...
 */
public class TranslateTranslator implements IIteratorTranslator {
    private String key;
    ...
    public TranslateTranslator(String key) {
        this.key = key;
    }
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        String translate = new TranslateTranslator("k").translateWhile(q);
    ...
    private String translate(String q) {
        String url = TranslateTranslator.apiUrl;
